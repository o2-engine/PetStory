...
{
    FIELD().PUBLIC().SERIALIZABLE_ATTRIBUTE().NAME(chipType);
    FIELD().PUBLIC().SERIALIZABLE_ATTRIBUTE().DEFAULT_VALUE(0).NAME(count);
}
END_META;
...
CLASS_FIELDS_META(LevelSpawnPoint)
{
    ...
    FIELD().PUBLIC().SERIALIZABLE_ATTRIBUTE().DEFAULT_VALUE(Vec2F(400.0f, 100.0f)).NAME(zoneSize);
    FIELD().PUBLIC().SERIALIZABLE_ATTRIBUTE().NAME(colors);
    FIELD().PUBLIC().SERIALIZABLE_ATTRIBUTE().DEFAULT_VALUE(10).NAME(maxOnScreen);
    FIELD().PUBLIC().SERIALIZABLE_ATTRIBUTE().DEFAULT_VALUE(0.2f).NAME(spawnDelay);
}
END_META;
...
CLASS_FIELDS_META(LevelWall)
{
    ...
    FIELD().PUBLIC().SERIALIZABLE_ATTRIBUTE().DEFAULT_VALUE(36.0f).NAME(width);
    FIELD().PUBLIC().SERIALIZABLE_ATTRIBUTE().DEFAULT_VALUE(false).NAME(closed);
}
END_META;
...
CLASS_FIELDS_META(LevelData)
{
    ...
    FIELD().PUBLIC().SERIALIZABLE_ATTRIBUTE().NAME(walls);
    FIELD().PUBLIC().SERIALIZABLE_ATTRIBUTE().NAME(spawners);
    FIELD().PUBLIC().SERIALIZABLE_ATTRIBUTE().NAME(goals);
    FIELD().PUBLIC().SERIALIZABLE_ATTRIBUTE().DEFAULT_VALUE(0).NAME(moves);
}
END_META;
