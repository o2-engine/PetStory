...
CLASS_FIELDS_META(GameFieldBorder)
{
    ...
    FIELD().PROTECTED().SERIALIZABLE_ATTRIBUTE().SERIALIZABLE_ATTRIBUTE().NAME(mBackImage);
    FIELD().PROTECTED().SERIALIZABLE_ATTRIBUTE().SERIALIZABLE_ATTRIBUTE().DEFAULT_VALUE(512.0f).NAME(mBackTileSize);
    FIELD().PROTECTED().SERIALIZABLE_ATTRIBUTE().SERIALIZABLE_ATTRIBUTE().NAME(mShadowImage);
    FIELD().PROTECTED().SERIALIZABLE_ATTRIBUTE().SERIALIZABLE_ATTRIBUTE().DEFAULT_VALUE(70.0f).NAME(mInnerShadowWidth);
    FIELD().PROTECTED().SERIALIZABLE_ATTRIBUTE().SERIALIZABLE_ATTRIBUTE().DEFAULT_VALUE(60.0f).NAME(mDropShadowWidth);
    FIELD().PROTECTED().SERIALIZABLE_ATTRIBUTE().SERIALIZABLE_ATTRIBUTE().DEFAULT_VALUE(Vec2F(0.0f, -15.0f)).NAME(mDropShadowOffset);
